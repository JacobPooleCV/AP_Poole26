public class BoxOfCandy{
    ...
    /**
     * Removes from box and returns a piece of candy with flavor specified by the paramenter, or
    ...
    // There may be instance variables, constructors, and methods that are not shown. Do not create your own, just write the methods given. 
