public class WeatherData{
    /** Guaranteed not to ber null and to contain only non-null entries */
    ...
    // There  may be instance variables, constructors, and methods that are not shown. Do not make your own, just write the methods given.
}